...
var KTAppsUsersListDatatable = function() {
	...
	// basic demo
	var _demo = function() {
		console.log(JSON.parse(HOST_URL + '/api/quotes'));
			...
			columns: [
				{
					...
					template: function(data) {
						...
						/*if (number > 8) {
							output = '<div class="d-flex align-items-center">\
								...
								<div class="ml-4">\
									<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">' + data.phone + '</div>\
					...
					template: function(row) {
						...
						output += '<div class="font-weight-bolder font-size-lg mb-0">' + city + '</div>';
						output += '<div class="font-weight-bold text-muted">Code: ' + city + '</div>';
					...
					template: function(row) {
						...
						output += '<div class="font-weight-bolder text-primary mb-0">' + created_at + '</div>';
