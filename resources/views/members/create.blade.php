	...
	<div class="card-body p-0">
		<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
			<div class="col-xl-12 col-xxl-12">
				<!--begin::Wizard Form-->
				{!! Form::open(['action'=>'TeamMemberController@store', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'form', 'id' => 'kt_form'])!!}
					@csrf	
				<div class="row justify-content-center">
						<div class="col-xl-12">
							<!--begin::Wizard Step 1-->
							<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
								<h5 class="text-dark font-weight-bold mb-10">Team Member's Profile Details:</h5>
								<!--begin::Group-->
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-xl-9">
										...
										<span class="form-text text-muted">Enter valid US phone number(e.g: 058967456).</span>
									</div>
								</div>
								<!--end::Group-->
								<!--begin::Group-->
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-xl-9">
										{!! Form::select('category_id', Helper::teamCategories()->pluck('name', 'id'),'', ['class' => 'form-control selectpicker','data-live-search' => 'true'])!!}
