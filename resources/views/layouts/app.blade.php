...
<html lang="en">
	...
	<body id="kt_body" style="background-image: url({{asset('assets/media/bg/bg-10.jpg')}})" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
								...
								<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
									...
									<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
										...
										<ul class="menu-nav">
											...
											<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
												<a href="{{url('proposals')}}" class="menu-link">
											...
											@elseif(auth()->user()->isCustomer())
												<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here">
													<a href="{{url('customers/'. auth()->user()->id )}}" class="menu-link">
											...
											<div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200">
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													<div class="d-flex flex-column mr-2">
														...
														<span class="text-muted">Best kichen gadget in 2021</span>
									...
									<div class="dropdown">
										...
										<div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px">
											<div class="btn btn-icon btn-hover-transparent-white d-flex align-items-center btn-lg px-md-2 w-md-auto">
												...
												@if (Helper::avatarCheck(auth()->user()->avatar))
													<span class="symbol symbol-35 symbol-sm flex-shrink-0 mr-2">
														<img class="" src="{{asset('uploads/images/avatars/'.auth()->user()->avatar)}}" alt="Avatar" />
													</span>
												@else
													<span class="symbol symbol-35 symbol-sm flex-shrink-0 symbol-light-primary mr-2">
										...
										<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
											<!--begin::Header-->
											@if (auth()->user()->isAdmin())
												<a href="{{url('admins/'.auth()->user()->id)}}">
											@elseif (auth()->user()->isCustomer())
												<a href="{{url('customers/'.auth()->user()->id)}}">
											@elseif (auth()->user()->isTeamMember())
												<a href="{{url('team/'.auth()->user()->id)}}">
											@endif 
											<div class="d-flex align-items-center p-8 rounded-top">
											<!--begin::Symbol-->
												@if (Helper::avatarCheck(auth()->user()->avatar))
													<div class="symbol symbol-40 symbol-sm flex-shrink-0 mr-2">
														<img class="" src="{{asset('uploads/images/avatars/'.auth()->user()->avatar)}}" alt="Avatar" />
													</div>
												@else
													<div class="symbol symbol-40 symbol-sm flex-shrink-0 symbol-light-primary mr-2">
														<span class="symbol-label font-size-h4">
															{{auth()->user()->name[0]}}
														</span>
													</div>
											...
											<div class="navi navi-spacer-x-0 pt-5">
												<!--begin::Item-->
												@if (auth()->user()->isAdmin())
													<a class="navi-item px-8 d-none">
												@elseif (auth()->user()->isCustomer())
													<a href="{{url('customers/'.auth()->user()->id)}}" class="navi-item px-8">
												@elseif (auth()->user()->isTeamMember())
													<a href="{{url('team/'.auth()->user()->id)}}" class="navi-item px-8">
												@endif 
													<div class="navi-link">
														<div class="navi-icon mr-2">
												...
												@if (auth()->user()->isAdmin())
													<a href="{{url('settings')}}" class="navi-item px-8">
														<div class="navi-link">
															<div class="navi-icon mr-2">
																<i class="flaticon2-settings text-warning"></i>
															</div>
															<div class="navi-text">
																<div class="font-weight-bold">Settings</div>
																<div class="text-muted">Application settings and more</div>
															</div>
														</div>
													</a>
												@endif
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href= "http://ccit.sa" target="_blank" class="text-dark-75 text-hover-primary">CCIT</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
							<div class="nav nav-dark order-1 order-md-2">
								<a href="http://ccit.sa/#about" target="_blank" class="nav-link pr-3 pl-0">About</a>
								<a href="http://ccit.sa/#about" target="_blank" class="nav-link px-3">Team</a>
								<a href="http://ccit.sa/#contact" target="_blank" class="nav-link pl-3 pr-0">Contact</a>
							</div>
							<!--end::Nav-->
						</div>
						<!--end::Container-->
		...
		@if (auth()->user()->isAdmin())
			<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 mt-4">
				<!--begin::Item-->
				<li class="nav-item mb-2" id="kt_demo_panel_toggle" data-toggle="tooltip" title="Settings" data-placement="right">
				<a class="btn btn-sm btn-icon btn-bg-light btn-text-success btn-hover-success" href="{{url('settings')}}">
						<i class="flaticon2-gear"></i>
					</a>
				</li>
				<!--end::Item-->
		...
		<div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-header d-flex align-items-center justify-content-between pb-7">
				<h4 class="font-weight-bold m-0">Settings</h4>
			...
			<div class="offcanvas-content">
				...
				<div class="offcanvas-wrapper mb-5 scroll-pull">
					<div class="navi navi-bold navi-hover navi-active navi-link-rounded mt-5 pt-1">
						...
						<div class="navi-item mb-2">
							<a href="{{url('tickets')}}" class="navi-link py-4">
								
								<span class="navi-icon mr-2">
									<span class="svg-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo2\dist/../src/media/svg/icons\Shopping\Price1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<polygon points="0 0 24 0 24 24 0 24"/>
		...
		<script> 
			...
			var asset_dir = {!!json_encode(asset('/'))!!};
		</script>
