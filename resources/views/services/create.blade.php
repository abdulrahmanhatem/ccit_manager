        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card card-custom">
                    ...
                    <!--begin::Form-->
                    {!! Form::open([ 'action'=> ['ServiceController@store'], 'method'=>'POST', 'files' => true, 'enctype' => 'multipart/form-data', 'class' => '', 'id' => '' ]) !!}
                    @csrf    
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label text-lg-right">Service Name:</label>
                                <div class="col-lg-7">
                                    <input name="name" type="text" class="form-control required" placeholder="Service Name" value=""> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input name="name_ar" type="text" class="form-control required" placeholder="Service Arabic Name" value=""> 
