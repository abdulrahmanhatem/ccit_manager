...
<head>
    ...
    <meta name="description" content="CCIT - Job Application Form CCIT with Resume upload and Branch feature">
    <meta name="author" content="CCIT">
    <title>CCIT</title>

    <!-- Favicons-->
    <link rel="shortcut icon" href="{{asset('assets/jobs/img/favicon.ico')}}" type="image/x-icon">
    ...
    <!-- BASE CSS -->
    <link href="{{asset('assets/jobs/css/bootstrap.min.css')}}" rel="stylesheet">
	<link href="{{asset('assets/jobs/css/menu.css')}}" rel="stylesheet">
    <link href="{{asset('assets/jobs/css/style.css')}}" rel="stylesheet">
	<link href="{{asset('assets/jobs/css/vendors.css')}}" rel="stylesheet">

    <!-- YOUR CUSTOM CSS -->
    <link href="{{asset('assets/jobs/css/custom.css')}}" rel="stylesheet">
	
	<!-- MODERNIZR MENU -->
	<script src="{{asset('assets/jobs/js/modernizr.js')}}"></script>
...
<body>
	...
	<nav>
		<ul class="cd-primary-nav">
			...
			<li><a href="https://CCIT.sa/#" class="animated_link">About Us</a></li>
			<li><a href="https://CCIT.sa/#service" class="animated_link">Services</a></li>
			<li><a href="index.html" class="animated_link">Jobs</a></li>
			<li><a href="https://CCIT.sa/#service" class="animated_link">Why We</a></li>
		</ul>
	</nav>
	<!-- /menu -->
	    ...
	    <div class="row row-height">
	        <div class="col-xl-4 col-lg-4 content-left">
	            <div class="content-left-wrapper">
	                <a href="index.html" id="logo"><img src="{{asset('assets/jobs/img/logo.png')}}" alt="" width="120" height="45"></a>
	                <div>
	                    <figure><img src="{{asset('assets/jobs/img/info_graphic_1.svg')}}" alt="" class="img-fluid" width="270" height="270"></figure>
	                    <h2>We are Hiring</h2>
	                    <p>Academic Certificate is not as important as professionalism and mastery of programming languages.</p>
	                    <span  class="btn_1 rounded yellow">Start With Us</span>
	                    <span class="btn_1 rounded mobile_btn yellow">Start With Us</span>
	                </div>
	                <div class="copy">© 2020 CCIT</div>
	            </div>
	            ...
	            <div id="wizard_container">
	                ...
	                <form id="wrapped" method="post" enctype="multipart/form-data">
	                    ...
	                    <div id="bottom-wizard">
							...
							<button class="submit"><a href="https://ccit.sa/ar/" class="submit text-white">Submit</a></button>
	...
	<!-- COMMON SCRIPTS -->
	<script src="{{asset('assets/jobs/js/jquery-3.2.1.min.js')}}"></script>
    <script src="{{asset('assets/jobs/js/common_scripts.min.js')}}"></script>
	<script src="{{asset('assets/jobs/js/velocity.min.js')}}"></script>
	<script src="{{asset('assets/jobs/js/common_functions.js')}}"></script>
	<script src="{{asset('assets/jobs/js/file-validator.js')}}"></script>

	<!-- Wizard script-->
	<script src="{{asset('assets/jobs/js/func_1.js')}}"></script>
