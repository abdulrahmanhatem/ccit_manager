        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom">
                    ...
                    <!--begin::Form-->
                    {!! Form::open([ 'action'=> ['ContractController@update', $contract->id], 'method'=>'POST', 'files' => true, 'enctype' => 'multipart/form-data', 'class' => '' ]) !!}
                    @csrf    
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-lg-3 col-form-label text-lg-right">Project Name:</label>
                                <div class="col-lg-4">
                                    {!! Form::select('project_id', Helper::projects()->pluck('name', 'id'), $contract->project_id, ['class' => 'form-control selectpicker required','data-live-search' => 'true'])!!}	
                            ...
                            <label class="col-lg-3 col-form-label text-lg-right">Grand Total:</label>
                                <div class="col-lg-4">
                                    ...
                                    {!! Form::text('grand_total', $contract->grand_total, ['class' => 'form-control required'])!!}	
                                ...
                                <div class="col-lg-9">
                                    <div class="dropzone dropzone-multi" id="kt_dropzone_4">
                                        <div class="dropzone-panel mb-lg-0 mb-2">
                                            <label class="dropzone-select btn btn-light-primary font-weight-bold btn-sm required" for="docs_{{$contract->id}}">Attach files</label>
                                            <input name="docs" type="file" id="docs{{$contract->id}}" hidden> 
                                        </div>
                                    ...
                                    <p id="file_preview_{{$contract->id}}"></p>
                                </div>
                            </div>
                        </div>
