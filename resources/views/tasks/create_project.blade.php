		...
		<div class="wizard wizard-1" id="kt_projects_add" data-wizard-state="step-first" data-wizard-clickable="true">
			...
			<div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
				<div class="col-xl-12 col-xxl-12">
					<!--begin::Form Wizard-->
					{!! Form::open(['action'=>'TaskController@store', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'form', 'id' => 'kt_form'])!!}
						@csrf
						<!--begin::Step 1-->
							...
							<div class="row">
								<div class="col-xl-12">
									...
									<div class="form-group row">
										<label class="col-xl-3 col-lg-3 col-form-label">Task</label>
										<div class="col-lg-9 col-xl-9">
											<input class="form-control form-control-lg required" name="name" type="text" placeholder="Task Name" />
											<span class="form-text text-muted">Please Choose Task Name</span>
										</div>
									</div>
									
									{!! Form::text('project_id', $project->id, ['class' => 'form-control selectpicker required','hidden'])!!}
										...
										<div class="col-lg-9">
											<div class="dropzone dropzone-multi" id="kt_dropzone_4">
												<div class="dropzone-panel mb-lg-0 mb-2">
													<label class="dropzone-select btn btn-light-primary font-weight-bold btn-sm" for="create-docs">Attach files</label>
