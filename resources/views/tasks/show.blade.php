                                            ...
                                            <div class="list list-hover min-w-500px" data-task="list">
                                                @if (count($tasks) > 0)
                                                    @foreach ($tasks as $task)
                                                        <!--begin::Item-->
                                                        @if ($task->id == $expTask->id)
                                                            <div class="d-flex align-items-start list-item card-spacer-x py-4 " data-task="task" style=" background-color: #F3F6F9;">
                                                        @else
                                    ...
                                    <div class="card card-custom card-stretch" id="kt_todo_view">
                                            ...
                                            <div class="d-flex align-items-center my-2">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-35 mr-3">
                                                        <div class="symbol-label" style="background-image: url('{{asset('assets/media/users/100_12.jpg')}}')"></div>
                                                    </div>
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between flex-wrap card-spacer-x py-3">
                                                ...
                                                <a href="#" class="text-dark text-hover-primary font-weight-bold font-size-h4 mr-3">{{$expTask->name}}</a>
                                                    <div class="d-flex align-items-center py-1">
                                                        ...
                                                        @endif
                                                        @if ($expTask->project->priority == 1)
                                                            <a href="#" class="d-flex align-items-center text-muted text-hover-primary">
                                                            <span class="fa fa-genderless text-danger icon-md mr-2"></span>Urgent</a>
                                                        @elseif ($expTask->project->priority == 2)
                                                            <a href="#" class="d-flex align-items-center text-muted text-hover-primary">
                                                            <span class="fa fa-genderless text-primary icon-md mr-2"></span>Important</a>
                                                        @elseif ($expTask->project->priority == 3 || $expTask->project->priority == 0)
                                                            <a href="#" class="d-flex align-items-center text-muted text-hover-primary">
                                                            <span class="fa fa-genderless text-success icon-md mr-2"></span>Normal</a>
                                                        @elseif ($expTask->project->priority == 4)
                                                            <a href="#" class="d-flex align-items-center text-muted text-hover-primary">
                                                            <span class="fa fa-genderless text-warning icon-md mr-2"></span>Low</a>
                                                        @endif
                                                    </div>
                                                </div>
                                                <!--end::Title-->
                                            ...
                                            <div class="mb-3">
                                                <!--begin::Message-->
                                                    @if(count(Helper::taskComments($expTask->id)) > 0)
                                                            @foreach(Helper::taskComments($expTask->id) as $comment)
                                                        ...
                                                        {!! Form::open(['action'=>'CommentController@store', 'method'=>'POST', 'enctype' =>'multipart/form-data', ' novalidate', 'class' => 'form'])!!}
                                                            <div class="w-100">
                                                                ...
                                                                <div class="py-5 pl-8 pr-5 border-top w-100">
                                                                    ...
                                                                    <input name="task_id" type="text" hidden="hidden" value="{{$expTask->id}}">
                                                                </div>
                                                            <!--begin::Body-->
                                                            <!--begin::Footer-->
