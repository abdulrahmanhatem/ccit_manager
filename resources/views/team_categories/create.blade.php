                ...
                <div class="card card-custom ">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Category Details</h3>
                        </div>
                    </div>
                    <!--begin::Form-->
                    {!! Form::open([ 'action'=> ['TeamCategoryController@store'], 'method'=>'POST', 'files' => true, 'enctype' => 'multipart/form-data', 'class' => '', 'id' => '' ]) !!}
                    @csrf    
                        <div class="card-body">
                            <!--begin::Group-->
                                    <div class="form-group row team-category">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div class="image-input image-input-outline">
                                                <img class="image-input-wrapper" src="{{asset('assets/media/stock-600x600/img-12.jpg')}}" id="avatar_preview">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input name="name" type="text" class="form-control required" placeholder="Category Name" value=""> 
